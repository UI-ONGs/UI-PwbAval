let currentCategory = "instituicao"; // Default category
...
let geocoder;
let markersArray = [];
let allMarkers = []; // Array to keep all markers
...
function createMarker({ lat, lng, name, description, category, images, street, neighborhood, city }) {
    ...
    const marker = new google.maps.Marker({
        ...
        map: map,
        title: name,
        category: category // Add category to the marker
    });
